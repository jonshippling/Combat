...
public class LevelBuilder
{
    ...
    private void addPlayer( int playerID, StringTokenizer tokens )
    {
        ...
        ImageIcon tmp = new ImageIcon( tokens.nextToken() );
        DirectionalImage image = new DirectionalImage( tmp.getImage() );
        image.setState(new ImageStateN(image));
        ...
        System.out.println("I'm making a player");
        switch(playerID)
        {
            case 1:  player1 = new PlayerManager( 1, ci.getCommands(playerID), player, bullet, ci );
                player1.start();
                break;
            case 2:  player2 = new PlayerManager( 2, ci.getCommands(playerID), player, bullet, ci );
                player2.start();
                break;
            default:
        }
