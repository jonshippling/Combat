...
public class DirectionalImage
{
    ...
    /**
     * This class' default image if no state is available
     */
    Image defaultImage;
    ...
    public DirectionalImage( Image base )
    {
        ...
        defaultImage = base;
        prevState = new ImageStateN(this);
//      state = new ImageStateN(this);
    }
    ...
    {
        return state != null ? state.getDirection() : active;
    }
    ...
    /**
     * Allows changing of state for the State Pattern
    ...
    public Rectangle paint( Graphics g )
    {
        ...
        Image toDraw = state == null ? defaultImage : state.getImageIcon().getImage();
    ...
    {
        Image current = state == null ? defaultImage : state.getImageIcon().getImage();
        if( current == null ) current = defaultImage;
    ...
    {
        Image current = prevState.getImageIcon().getImage();
        if( current == null ) current = defaultImage;
        int height = current.getHeight( null );
        int width = current.getWidth( null );
