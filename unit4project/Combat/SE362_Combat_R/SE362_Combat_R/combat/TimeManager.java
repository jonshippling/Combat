...
public class TimeManager extends Thread
{
    ...
    private volatile LinkedList<Timed> clocked = null;   //the clocked objects
        ...
        try
        {
            ...
            while( true )
            {
                ...
                if( !paused )
                {
                    ...
                    ListIterator<Timed> it = clocked.listIterator();
                    
                    // do a pretick broadcast
                    while( it.hasNext() )
                        it.next().pretick();
                    
                    it = clocked.listIterator();
                    while( it.hasNext() )
                        it.next().tick();
                }
