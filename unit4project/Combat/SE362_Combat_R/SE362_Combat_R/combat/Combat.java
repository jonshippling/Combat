...
public class Combat {
    ...
    static ArrayList<Integer> player1cmd = new ArrayList<Integer>();
    static ArrayList<Integer> player2cmd = new ArrayList<Integer>();
    ...
    public static void main( String argv[] )
    {
        ...
        try
        {
            ...
            // on the content pane.
            CombatMenu cm = new CombatMenu( theGame, player1cmd, player2cmd );
